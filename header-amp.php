				...
				<div class="row h-100">
					...
					<div class="col-12 col-md-3  my-auto text-center text-md-left">
						...
						<div class="a2a_kit header-share-buttons">
							...
							<!-- <a class="twitter-follow-button" href="https://twitter.com/worldwidetrials" data-show-screen-name="false" data-show-count="false"></a> -->
				...
				<div class="col-8 offset-2 text-center text-md-left col-md-3 offset-md-0 col-sm-8 h-100">
					...
					<h1 id="logo" class="h-100">
						...
						<?php } else { ?>
							...
							<amp-img src="<?php echo get_template_directory_uri() ?>/img/worldwide-logo.png" alt="<?php echo get_bloginfo('name') ?>" title="<?php echo get_bloginfo('description') ?>"></amp-img>
